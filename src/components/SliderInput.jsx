		...
		<div className="flex items-center gap-4">
			<div className="flex-1 mt-1">
				...
				>
					...
					<Slider.Thumb
						className="block h-5 w-5 rounded-full border-2 border-white bg-white ring-offset-canvas transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
						aria-label="Volume"
					/>
				</Slider.Root>
			</div>
